package com.hariz.noah.Provider;
...
import com.hariz.noah.Network.Database.DatabaseContract;
import com.hariz.noah.Network.Database.FavHelper;

import static com.hariz.noah.Network.Database.DatabaseContract.AUTHORITY;
...
public class FavProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        favoriteHelper = new FavHelper(getContext());
        favoriteHelper.open();
        return true;
    }
